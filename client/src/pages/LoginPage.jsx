...
// --- Komponen Ikon SVG yang Dapat Digunakan Kembali ---
...
// --- Komponen Input Form yang Dapat Digunakan Kembali ---
const FormInput = ({
  id,
  name,
  type,
...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      console.log("Kirim ke backend:", credentials);
      ...
      <div className="hidden lg:flex w-1/2 items-center justify-center bg-gradient-to-tr from-blue-800 to-indigo-500 text-white p-12">
        <div className="max-w-md text-center">
          ...
          <p className="mt-4 text-lg text-blue-200">
            Masuk untuk melanjutkan dan mengelola tugas Anda.
          </p>
        </div>
      </div>
